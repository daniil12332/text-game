...
while mode != 5:
	...
	while mode == 3:
		...
		if a = "w" and game[p_index - x-1] == " ":
			game[p_index] = " "
			p_index -= x+1
			game[p_index] = "O"
		if a = "s" and game[p_index + x+1] == " ":
			game[p_index] = " "
			p_index += x+1
			game[p_index] = "O"
		if a = "a" and game[p_index - 1] == " ":
			game[p_index] = " "
			p_index -= 1
			game[p_index] = "O"
		if a = "d" and game[p_index + 1] == " ":
			game[p_index] = " "
			p_index += 1
			game[p_index] = "O"
